...
<head>
    ...
    <title>ELMO CLOUD | Impressum</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Impressum</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <p>Prof. Dr. Christian Decker<br />
                                    Danziger Str. 6<br />71034 Böblingen</p>
                                <p>Telefon: +49 (0)7121 271-4105<br />
                                    Telefax: +49 (0)7121 271-4032<br />
